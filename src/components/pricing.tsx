      ...
      <div className="flex flex-col min-h-screen pt-3  sm:mt-5 sm:mx-1 relative overflow-hidde">
        ...
        <div className="bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] p-1 mt-10 md:mt-10 shado  max-w-4xl md:max-w-screen">
          ...
          <span className="text-sm/8 text-gray-500 mt-6  block text-center">
            All features are included in every plan. No hidden fees or By
            connecting actions directly to performance metrics, UNIQ Heights
            transforms Amazon selling from an intuition-based process to a
            data-driven operation, significantly improving efficiency and
            profitability
          </span>
        </div>
      </div>
